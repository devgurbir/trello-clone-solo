        ...
        <div className={styles.accountForm}>
            ...
            <div className={styles.mainContainer}>
                <div className={styles.loginForm}>
                    <input onChange={e => setVal(e.target.value)} type="text" className={styles.formField} name="user" placeholder="Enter email" style={{marginBottom: 0}} />
                    ...
                    {val.includes("@") ? <button className={styles.loginBtn}>Continue</button> : <button className={styles.loginBtn} disabled>Continue</button> }
                </div>
                ...
                <hr />
                <span className={styles.bottomFormLink}><a href="/login">Already have an account? Log In</a></span>
            </div>
        </div>
    </div>
  )
