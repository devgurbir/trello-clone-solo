  ...
  return (
    <div className={styles.hero}>
        ...
        <div className={styles.container}>
            ...
            <img src="https://d2k1ftgv7pobq7.cloudfront.net/meta/p/res/images/spirit/hero/6a3ccd8e5c9a0e8ebea4235d12da6b24/hero.png" width="931" height="1205" className={styles.imgFluid} alt="img" />
            </div>
        </div>
    </div>
  )
